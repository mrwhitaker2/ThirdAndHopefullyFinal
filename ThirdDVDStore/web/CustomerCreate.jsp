    ...
    <body>
        <h1>Welcome! </h1>
          ...
          <form method="POST" action='CustomerController' name="frmAddCustomer"> 
            ...
            Password : <input
                type="password" required  name="Password"  minlength="8" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"
