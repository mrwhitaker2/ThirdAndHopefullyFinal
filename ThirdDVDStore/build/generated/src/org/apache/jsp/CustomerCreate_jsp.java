...
public final class CustomerCreate_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                $('#debit').hide();\r\n");
      out.write("                $('#credit').hide();\r\n");
      out.write("                $('#check').hide();\r\n");
      out.write("                $('#criteria').change(function () {\r\n");
      out.write("                    if ($('#criteria option:selected').text() == \"Debit\") {\r\n");
      out.write("                        $('#debit').show();\r\n");
      out.write("                        $('#credit').hide();\r\n");
      out.write("                        $('#check').hide();\r\n");
      out.write("                    } else if ($('#criteria option:selected').text() == \"Credit\") {\r\n");
      out.write("                        $('#actor').show();\r\n");
      out.write("                        $('#debit').hide();\r\n");
      out.write("                        $('#check').hide();\r\n");
      out.write("                    } else if ($('#criteria option:selected').text() == \"Check\") {\r\n");
      ...
      out.write("            <h1>Customer Creation</h1><br/>\r\n");
      out.write("            <input\r\n");
